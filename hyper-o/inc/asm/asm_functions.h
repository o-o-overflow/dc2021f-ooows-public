...
int _vmlaunch(struct ooo_regs *guest_gprs);
int _vmresume(struct ooo_regs *guest_gprs);
...
// fuck it. Taken from https://github.com/shubham0d/ProtoVirt/blob/master/protovirt.h
// CH 24.11.2, Vol 3
